...
function TaskWorkspace({ task, student, onBack, onUpdate }) {
  ...
  return <div className="workspace-page">
    ...
    <div className="workspace-grid">
      ...
      </div>}<button className="primary submit" onClick={submit} disabled={uploading||result==='correct'}>{uploading?'채점하는 중...':result==='correct'?'제출 완료':result==='wrong'?'수정해서 다시 제출':'과제 제출하기'}{!uploading&&result!=='correct'&&<ArrowRight size={18}/>}</button></div></section>
